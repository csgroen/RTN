%\VignetteIndexEntry{Main vignette:Transcriptional Network Inference and Analysis of Master Regulators in R}
%\VignetteKeywords{Transcriptional Network Inference and Analysis of Master Regulators in R}
%\VignettePackage{RTN}
...
tna.plot.gsea1(rtna, width=6, height=4, 
