...
tna.plot.gsea1(rtna, file="tna_gsea1", labPheno="abs(log2) diff. expression values") 
tna.plot.gsea2(rtna, file="tna_gsea2", labPheno="log2 diff. expression values") 
@ 
\end{small}
